...
HD_PWD='C:/Users/thoma/EBER/GIT/EBER/simple-motor-2018.2/simple-motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block_design_wrapper.tcl -notrace
