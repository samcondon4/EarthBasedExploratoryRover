...
HD_PWD='C:/Users/thoma/EBER/GIT/EBER/simple-motor-2018.2/simple-motor.runs/block_design_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_axi_timer_0_0.tcl
